...
gdown $META_MODELS_URL -O data/meta-models/meta-models.zip \
...
gdown $META_SAMPLERS_URL -O data/meta-samplers/meta-samplers.zip \
...
wget -c -q --show-progress $MERL_DATA_URL -O data/brdfs/brdfs.zip \
